...
export default function Header(){
    ...
    <div className="header">
        <header className="header-box">
            ...
            <p className="header-p">Search for California parks by name, narrow your search
                by what activities are offered, or locate on the map below - once you find what you're looking for,
