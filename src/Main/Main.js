  ...
  useEffect(() => {
    ...
    <div className="main">
        ...
        <section className="main-section">
           ...
           containerElement={<div style={window.innerWidth < 500 ? { height: `500px`, width: `100%`, paddingBottom: `50px`, marginLeft: `auto`, marginRight: `auto` }: { height: `500px`, width: `80%`, paddingBottom: `50px`, marginLeft: `auto`, marginRight: `auto` } } />}/>
        :
